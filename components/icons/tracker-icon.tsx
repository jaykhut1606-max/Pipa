  ...
  return (
    <Tile size={size} className={className} bg="#DDE7EF">
      <svg viewBox="0 0 64 64" width={s} height={s} aria-hidden>
        ...
        />
        {/* tick marks */}
        <line x1="38" y1="28" x2="42" y2="28" stroke="#3a2f33" strokeWidth="1.5" />
        <line x1="38" y1="33" x2="42" y2="33" stroke="#3a2f33" strokeWidth="1.5" />
      </svg>
    </Tile>
  );
}
    ...
    <Tile size={size} className={className} bg="#D9E5DA">
      <svg viewBox="0 0 64 64" width={s} height={s} aria-hidden>
        <path
          ...
          strokeLinejoin="round"
        />
        <path d="M40 12v8h8" fill="none" stroke="#3a2f33" strokeWidth="2.5" />
  ...
  return (
    <Tile size={size} className={className} bg="#DDE7EF">
      <svg viewBox="0 0 64 64" width={s} height={s} aria-hidden fill="none">
        <circle cx="32" cy="34" r="14" fill="#fff" stroke="#3a2f33" strokeWidth="2.5" />
        <path d="M26 32a2 2 0 1 1-2-2" stroke="#3a2f33" strokeWidth="2.5" strokeLinecap="round" />
        <path d="M40 32a2 2 0 1 1-2-2" stroke="#3a2f33" strokeWidth="2.5" strokeLinecap="round" />
        <path d="M27 42c2 1.4 3.4 1.4 5 0c1.6 1.4 3 1.4 5 0" stroke="#3a2f33" strokeWidth="2.5" strokeLinecap="round" fill="none" />
        <path d="M22 30 L20 22 L24 26 Z M42 30 L46 22 L46 26 Z" fill="#A8C0D6" stroke="#3a2f33" strokeWidth="1.5" strokeLinejoin="round" />
      </svg>
    </Tile>
  );
}
